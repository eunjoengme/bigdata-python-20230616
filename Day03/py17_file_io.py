...
#filename = 'C:/Temp/sample.txt' # 상대경로
#filename = 'C:\\Users\\Administrator\\eclipse-workspace\\bigdata-python-20230616\\Day03\\test.txt' #절대경로
#filename = 'C:/Users/Administrator/eclipse-workspace/bigdata-python-20230616/Day03/test2.txt' #절대경로 리눅스/유닉스와 동일하게 사용가능
